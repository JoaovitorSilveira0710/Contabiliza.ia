...
from erpbrasil.edoc.pdf.danfe import Danfe as ErpDanfe

class DanfeErpBrasilAdapter:
    """Adapter para gerar DANFE usando erpbrasil.edoc.pdf a partir do nosso modelo Invoice."""
